...
//用户框失去焦点后验证value值
function oBlur_1() {
    if (!document.getElementsByTagName("input")[0].value) { //用户框value值为空
...
//密码框失去焦点后验证value值
function oBlur_2() {
    if (!document.getElementsByTagName("input")[1].value) { //密码框value值为空
...
//若输入框为空，阻止表单的提交
function submitTest() {
    if (!document.getElementsByTagName("input")[0].value && !document.getElementsByTagName("input")[1].value) { //用户框value值和密码框value值都为空
        document.getElementById("remind_1").innerHTML = "请输入用户名！";
        document.getElementById("change_margin_1").style.marginBottom = 1 + "px";
        document.getElementById("remind_2").innerHTML = "请输入密码！";
        document.getElementById("change_margin_2").style.marginBottom = 1 + "px";
    ...
    } else if (!document.getElementsByTagName("input")[0].value) { //用户框value值为空
        document.getElementById("remind_1").innerHTML = "请输入用户名！";
        document.getElementById("change_margin_1").style.marginBottom = 1 + "px";
        return false;
    } else if (!document.getElementsByTagName("input")[1].value) { //密码框value值为空
        document.getElementById("remind_2").innerHTML = "请输入密码！";
        document.getElementById("change_margin_2").style.marginBottom = 1 + "px";
        document.getElementById("change_margin_3").style.marginTop = 2 + "px";
        return false;
